create database OptiConstructServer;
use OptiConstructServer;
...
INSERT INTO Clientes ( NombreUsuario , UsuarioId) VALUES
  ...
  INSERT INTO Material ( NombreMaterial, Descripcion, unidadBase, Categoria) VALUES
( 'Ladrillo', 'Ladrillo Modular', ' ', ' ');